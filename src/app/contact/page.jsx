      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Estoy en busca de oportunidades laborales como
            programador, si tienes alguna oportunidad laboral para mí, conocer mas sobre mis proyectos, puedes
            contactarme en el formulario y  me pondré en contacto
            contigo lo más pronto posible. <i className="bi bi-emoji-laughing"></i>
          </p>
        </div>
