        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden max-w-4xl mx-auto">
          <div className="md:flex">
            ...
            <div className="bg-indigo-600 text-white md:w-2/5 p-8">
              ...
              <p className="mb-8">
                También puedes contactarme directamente usando la siguiente información:
              </p>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/tuusuario" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-200">
                  ...
                  <a href="https://linkedin.com/in/tuusuario" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-200">
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                    </svg>
                  </a>
                  <a href="https://twitter.com/tuusuario" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-200">
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-8 md:w-3/5">
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-4">¡Mensaje enviado!</h3>
                  <p className="text-gray-600 mt-2">Gracias por contactarme. Te responderé lo antes posible.</p>
                  <button 
